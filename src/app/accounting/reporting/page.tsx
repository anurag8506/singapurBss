                                ...
                                <div className='col-md-10'>
                                    ...
                                    <div className='sm:flex sm:justify-start justify-center   '>
                                        <div className="flex sm:justify-start justify-center   items-center sm:pt-4 pt-2 sm:mr-4">
                                            <button className=" border border-dark text-[#000] font-medium sm:w-[200px] w-full   px-6 py-[8px] rounded-full mb-4  p-text hover:bg-[#000] hover:text-[#fff]">
                                                Get Started
                                            </button>
                                        </div>
                                        <div className="flex sm:justify-start justify-center   items-center sm:pt-4 pt-2 sm:mr-4">
                                            <button className=" border border-dark text-[#000] font-medium sm:w-[200px] w-full  px-6 py-[8px] rounded-full mb-4 hover:bg-[#000] hover:text-[#fff]">
                                                Schedule a call
                                            </button>
                                        </div>
