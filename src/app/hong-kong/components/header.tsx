            ...
            <div className="col-md-10">
              <div className={(width < 500) ? menu ? "row flex justify-between items-center absolute bg-[#fff] w-100 left-0 top-[80px] pt-10 pb-28 " : "hidden " : "row flex justify-between items-center"}>
                <div className="col-md-9">
                  <div className="sm:text-center text-start sm:pl-0 pl-5 align-items-center sm:flex justify-center gap-[80px] ">
                    <Link href="/hong-kong/about" className="no-underline block header-text-para">
                      <span className="font-[cd-m] font-[500] text-[#212833] text-end text-[13px]  ">
                        About
                      </span>
                    </Link>

                    <Link href="/hong-kong/company-registration" className="no-underline block header-text-para">
                      <span className="font-[cd-m] font-[500] text-[#212833] text-end text-[13px]  ">
                        Company Registration
                      </span>
                    </Link>
                    <span className="block  menulist  font-[cd-m] font-[500] text-[#212833]  text-[13px] header-text-para  ">
                      Accounting & Audit
                      ...
                      <div className="menu-item  relative sm:absolute py-[12px]  sm:top-[60px]">
                        ...
                        <ul className="rounded-lg max-w-md  bg-[#fff] border-1 border-[#A2A2A2] px-4 py-3 z-10">
                          ...
                          <li className="pt-[5px]">
                            <Link
                              href="/hong-kong/accounting-audit/accounting-services"
                              className="font-[cd-r] font-[500] no-underline sm:text-[12px] text-[#000]"
                            >Accounting Services
                            </Link>
                          </li>
                          <li className="pt-[5px]">
                            <Link
                              href="/hong-kong/accounting-audit/bookkeeping"
                              className="font-[cd-r] font-[500] no-underline sm:text-[12px] text-[#000]"
                            >Bookkeeping
                            </Link>
                          </li>
                          <li className="pt-[5pxx]">
                            <Link
                              href="/hong-kong/accounting-audit/company-audit"
                              className="font-[cd-r] font-[500] no-underline sm:text-[12px] text-[#000]"
                            >Company Audit
                            </Link>
                    ...
                    <Link href="/hong-kong/secretary" className=" no-underline block z-10  menulist ff-type font-[100] cursor-pointer  text-[#000] text-start text-[13px] header-text-para ">
                ...
                <div className="col-md-3 ">
                  <div className="sm:text-end align-items-center sm:flex sm:justify-end">
                    <Link href="#" className=" no-underline block px-6 header-text-para ">
                    ...
                    <Link href="#" className="block sm:pt-[0px] pt-[15px] ml-5 no-underline align-items-center  header-text-para" ><button className="no-underline block z-10 sm:pt-[7px] pt-[15px] menulist ff-type font-[100] cursor-pointer  text-[#fff] text-start text-[13px] bg-[#000] px-5 py-2 rounded-[30px]" type="button">Log in</button></Link>
                  </div>
                </div>
              </div>
            </div>
