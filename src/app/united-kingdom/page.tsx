                ...
                <section className="overflow-hidden sm:px-20 px-6  pt-32 pb-4">
                    <div className="flex items-center justify-center">
                        <div className="flex items-center px-4 py-2 border rounded-full border-black">
                            ...
                            <div className="ml-3 font-[cd-m] font-[500] no-underline sm:text-[13px] text-[#000]"> Trusted by 200k+ Companies</div>
                        </div>
                    </div>
                </section>
                <section>
                            ...
                            <div className="row justify-center ">
                                <div className="col-md-8">
                                    <div className="text-center">
                                        <p className="font-[cd-se]  no-underline sm:text-[45px] text-[30px] text-[#000] text-center sm:leading-[46px] leading-[32px]">Accounting experts and simple software for better businesses</p>
                                    </div>
                                </div>
                                <div className="col-md-8  pb-4 pt-2">
                                    <div className="text-center" >
                                        <Link href="/" >
                                            <button className=" sm:mb-0 mb-3 font-[cd-m] font-[500] text-[14px] text-[#000] bg-[#fff] opacity-100 h-[40px] rounded-[30px] text-center sm:w-[160px] w-full">Get Started</button>
                                        </Link>
                                        <Link href='/'>
                                            <button className="font-[cd-m] font-[500]  sm:ms-4 text-[14px] text-[#fff] bg-[#000] h-[40px] rounded-[30px] text-center sm:w-[160px] w-full ">Schedule a call</button>
                                        </Link>
                                    </div>
                                </div>
                                <div className="col-md-8">
                                    <Image src='/assets/image 23 (5).png' alt=".." width='3000' height='3000' className="w-full rounded-[10px]" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row justify-center">
                        <div className="col-md-5 pb-4">
                            <div className="text-center  ">
                                ...
                                <p className="font-[cd-se]  no-underline sm:text-[40px] text-[30px] text-[#000] text-center sm:leading-[38px] leading-[32px]">Services that give you peace of mind</p>
                            </div>
                        </div>
                    </div>
                    <div className="row">
