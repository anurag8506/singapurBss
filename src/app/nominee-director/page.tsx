                                   ...
                                   <div className="row align-items-center pb-10 ">
                                       <div className="col-md-6 mb-4">
                                           ...
                                           <div className='col-md-10'>
                                               <p className="font-[cd-r] font-[500] no-underline text-[16px]  text-[#212833] p-text ">Effortlessly meet Singapore’s regulatory requirements by appointing a Nominee Director. Choose Cloud BSS as your reliable partner in navigating Singapore&apos;s regulatory landscape.</p>
                                               ...
                                               <div className="flex sm:justify-start justify-center   items-center sm:pt-4 pt-2 sm:mr-4">
                                                   <button className=" border border-dark text-[#000] font-[cd-m] sm:w-[220px] w-full  px-6 py-[10px] rounded-full mb-4  hover:bg-[#000] hover:text-[#fff]">
                                                   Book a Consultation
                                                   </button>
                                               </div>
                                               <div className="flex sm:justify-start justify-center   items-center sm:pt-4">
                                                   <button className=" border border-dark  font-[cd-m] sm:w-[160px]  w-full  px-6 py-[10px] rounded-full mb-4  hover:bg-[#000] hover:text-[#fff]">
                                                   Pricing
                                                   </button>
                                               </div>
                                               </div>
                                               ...
                                               <div className="col-md-12 sm:pb-2">
                                                   <div className="text-center pb-2">
                                                       <div className='d-flex justify-center'> 
                                                           <div className=" px-2 py-[10px] font-[cd-m]  font-[500]  text-[#212833]  border border-dark rounded-[30px] sm:w-[180px] w-[180px] text-[14px] tracking-wider ">The process</div>
                                                       </div>
                       
                                                       <div className="row justify-center  sm:pb-4 pb-3">
                                                           <div className="col-md-5 sm:pt-3 pt-4  ">
                                                               <p className="font-[cd-se]  no-underline sm:text-[40px] text-[30px] text-[#212833]  sm:leading-[40px] leading-[30px]">A reliable Nominee Director to navigate local compliance</p>
                                                           </div>
                                                       </div>
                                                   </div>
                                               </div>
                                            ...
                                            <div className="col-md-5 mb-4 order-md-2 order-1 ">
                                              ...
                                              <Image src='/assets/image (6).png' alt=".." width='3000' height='3000' className="w-full" />
                                               ...
                                               <div className="col-md-5 mb-4 order-md-1 order-2">
                                                           <p className='text-[20px] font-[cd-se]  text-[#212833] '>Why does your company need a Nominee Director?</p>
                                                           <p className='font-[cd-r] font-[500] text-[#7C7C7C] text-[16px]  mb-0 '>Every company needs to have a resident director according to Singapore law. This is particularly important for foreigners who are waiting for the approval of their Employment Pass — once this is obtained, directors can become sole directors of their Singapore company.
                                                           </p>
                                               </div>
                                               ...
                                               <div className="col-md-5 mb-4 ">
                                                    ...
                                                    <div className="col-md-5 mb-4">
                                                           ...
                                                           <p className='text-[20px] font-[cd-se]  text-[#212833] '>The process of appointing a Nominee Director</p>
                                                           <p className='font-[cd-r] font-[500] text-[#7C7C7C] text-[16px]  mb-0 '>Choosing a reliable professional services provider is crucial when appointing a Nominee Director. This is important for those waiting for Employment Pass approval and for compliance with regulations.
...
Osome has various packages available for newly incorporated companies or existing ones looking to maintain their compliance in Singapore. We can assist depending on your needs and have quarterly, 6-month, and yearly services available.
            ...
            <section className="bg-[#FFFCF5] overflow-hidden sm:px-20 px-6 sm:py-[50px] py-[30px]">
                <div >
                        ...
                        <div className="text-center  ">
                            ...
                            <div className="row justify-center  pb-3">
                                <div className="col-md-6 sm:pt-5 pt-2 sm:pb-5 pb-2  ">
                                    <p className="font-[cd-se] font-[500]  sm:text-[35px] text-[28px] text-[#212833]  sm:leading-[38px] leading-[32px] text-center">Seamlessly maintain a good standing with the local authorities</p>
                                </div>
                            </div>
                        </div>
